...
import UserIcon from './components/pages/user/icon';
...
export default {
  ...
  banner: {
    ...
    dismissible: false,
    text: (
      <Link href="/user" style={{ textDecoration: 'none'}}>🎉 Wiki 个人空间 已上线测试！点击前往 →</Link>
    )
  },
  footer: {
    text: (
  ...
  sidebar: {
    ...
    titleComponent({ title, type }) {
      ...
      if (title === "欢迎") {
        return (
          <div style={{display: "flex", alignItems: "center"}}>
            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="#CDAF95"
      ...
      if (title === "公告") {
        return (
          <div style={{display: "flex", alignItems: "center"}}>
            <svg xmlns="http://www.w3.org/2000/svg" width="15" height="15" fill="#5F9EA0"
      ...
      if (title === "荣誉榜") {
        return (
          <div style={{display: "flex", alignItems: "center"}}>
            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="#B8860B"
        ...
        if (title === "佬友百科") {
            return (
                <div style={{display: "flex", alignItems: "center"}}>
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="#d5c6ac"
        ...
        if (title === "公开测试") {
          return (
            <div style={{display: "flex", alignItems: "center"}}>
              <svg xmlns="http://www.w3.org/2000/svg" width="15" height="15"fill="#FF6A6A"
        ...
        if (title === "更新记录") {
            return (
                <div style={{display: "flex", alignItems: "center"}}>
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="#228B22"
  ...
  gitTimestamp: ({ timestamp }) => {
    ...
    return `本页最后更新于 ${date.toLocaleDateString('zh-CN', options)}`;
  }
}